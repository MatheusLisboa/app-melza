/** Make: StatusBar — chrome mock iOS (protótipo) */
export function StatusBar() {
  return (
    <div className="relative flex h-11 shrink-0 items-center justify-between px-6">
      ...
      <div className="absolute left-1/2 h-7 w-[110px] -translate-x-1/2 rounded-b-[18px] bg-black" />
      <div className="flex items-center gap-1.5">
        <svg width="17" height="12" viewBox="0 0 17 12" fill="none" aria-hidden>
          <rect x="0" y="3" width="3" height="9" rx="1" fill="white" opacity="0.35" />
        ...
        <div className="flex items-center gap-0.5">
          <div className="relative h-[11px] w-[22px] rounded-[3px] border border-white/60 p-[2px]">
            <div className="h-full w-[13px] rounded-[1.5px] bg-white" />
          </div>
        </div>
      </div>
    </div>
